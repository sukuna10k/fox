...
app = Client("fox_token_bot", api_id=API_ID, api_hash=API_HASH, bot_token=BOT_TOKEN)
...
async def start_command(client: Client, message: Message):
        ...
        if referrer_id.isdigit() and int(referrer_id) != user.id:
            ...
            try:
                await client.send_message(
                    ...
                    text=f"🎉 Someone joined using your referral link! You've earned 10 Fox TOKEN."
                )
    ...
    keyboard = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("Join Community", url="https://t.me/Fox_TOKENs")],
        ]
    )
    ...
    text = (
        ...
        "or participate in bonus games on [Fox TOKEN 🦊](http://t.me/Fox_TOKENs_bot)."
    )

    # Send the welcome message
    await message.reply_photo(
        photo="https://envs.sh/4pg.jpg",
        caption=text,
...
async def help_command(client: Client, message: Message):
    text = (
        "[Fox TOKEN](http://t.me/Fox_TOKENs_bot) helps you earn tokens which you can convert to $TON.\n\n"
        "Click /earn to share your referral link and start earning Fox TOKEN.\n"
        "Click /balance to check your balance.\n"
        "Click /convert to convert your Fox TOKEN to $TON.\n\n"
        "1 invited user = 10 Fox TOKEN = $0.5 TON.\n"
        "You need 1000 Fox TOKEN to convert to $TON."
    )
...
async def balance_command(client: Client, message: Message):
    ...
    await message.reply(f"Your balance: {balance} Fox TOKEN. Share your referral link to earn more $FT.")
...
async def convert_command(client: Client, message: Message):
    ...
    balance = get_balance(user)
    if balance < 1000:
        await message.reply("Your balance is less than 1000 Fox TOKEN $FT.")
    else:
